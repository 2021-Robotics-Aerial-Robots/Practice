...
void ukf::predict(){
  ...
  /* ------------------
    Prediction: Define x_sigmavector
    Hint: sigma is already defined for you
  -------------------- */
  ...
  /* ------------------
    Prediction: Multiply by weight and sum up
    Hint: w_m(i)
  -------------------- */
